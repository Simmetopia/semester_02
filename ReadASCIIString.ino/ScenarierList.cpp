...
void ScenarierList::opretScenarie()
{
	...
	std::cout << "hvor mange elementer �nsker du at knytte til alarmen?" << std::endl;
	...
	for (auto i = 0; i < antalKnytninger; i++)
	{
		...
		std::cout << "F�rst timer p� alarm element nr:" << i + 1 << std::endl;
		std::cin >> hour;		
		std::cout << "S� minutter p� alarm element nr:" << i + 1 << std::endl;
		std::cin >> minut;
